    ...
    @autoreleasepool {
        ...
        while (true) {
            ...
            @autoreleasepool {
                ...
                image = CGWindowListCreateImage(CGRectMake(mouseLoc.x, 900 - mouseLoc.y, 1, 1), kCGWindowListOptionOnScreenOnly, kCGNullWindowID, kCGWindowImageDefault);
                ...
                if (color.greenComponent > 0.85 && color.greenComponent < 0.86 && color.redComponent > 0.25 && color.redComponent < 0.4 && color.blueComponent > 0.4 && color.blueComponent < 0.45 ) {
                    ...
                    int r = arc4random_uniform(60) + 50;
